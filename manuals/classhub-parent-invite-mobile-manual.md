...
若班級名單已透過 CSV 匯入，或班級內已建立多位學生與家長連結，教師可按「產生整班 QR Code」。ClassHub 會產生整班家長邀請卡片，每張卡片對應一位家長，包含學生、家長、邀請連結與 QR Code。老師可以逐張查看，也可以列印 QR Code 卡片。
...
- 整班名單匯入後，可使用「產生整班 QR Code」批次產生家長邀請卡片。
- 教師手機上不需要複製或貼上邀請碼。
